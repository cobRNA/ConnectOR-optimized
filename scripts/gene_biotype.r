...
#melted2$Species <- factor(melted2$Species, levels = c("hg38", "mm39"))
...
# Save the plot
ggsave("plots/gene_biotype_plot.pdf", plot = p, width = 2.5, height = 6, units = "in", dpi = 600)
ggsave("plots/gene_biotype_plot.jpg", plot = p, width = 2.5, height = 6, units = "in", dpi = 300)
ggsave("plots/gene_biotype_plot.png", plot = p, width = 2.5, height = 6, units = "in", dpi = 900, bg = "transparent")
