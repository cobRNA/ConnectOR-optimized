...
folder_path <- "Result/statistics/Bi_Directional/protein/"
...
for (file_path in file_list) {
    ...
    percentage = c(data2$pc / data2$pc, data2$no_pc_liftover / data2$pc, 
                 ...
                 data2$One_to_one_orth / data2$pc_liftover, data2$one_to_half / data2$pc_liftover, data2$One_to_many_orth / data2$pc_liftover, 
                 data2$Many_to_many_orth / data2$pc_liftover, data2$One_to_none_orth / data2$pc_liftover, 
    ...
    fill_color_vector = c("pc_conserved"="#a15284", 
                      ...
                      "one_to_half_conserved"="#880D1E",
                      "One_to_many_orth_conserved"="#DD2D4A",
                      "Many_to_many_orth_conserved"="#F26A8D",
    ...
    #print(compare_plot)
    ggsave(paste0("./plots/Bi_Directional/", file_name, "_Bi_Directional_protein_Orthologous.pdf"), plot = compare_plot, width = 8, height = 4)
}
