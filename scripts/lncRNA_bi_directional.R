...
folder_path <- "Result/statistics/Bi_Directional/lncRNA/"
...
for (file_path in file_list) {
    ...
    my_input <- data.frame(
    my_class = c("gene", "gene", "liftover", "liftover", "Orthologous", "Orthologous", "Orthologous", "Orthologous", "Orthologous", "One_to_one", "One_to_one", "One_to_one"),
    category = c("lncRNA", "no_lncRNA", "lncRNA_liftover", "no_lncRNA_liftover", 
               "One_to_one_orth", "one_to_half", "One_to_many_orth", "Many_to_many_orth", "One_to_none_orth", 
    ...
    freq = c(data2$lncRNA, data2$no_lncRNA, data2$lncRNA_liftover, data2$no_lncRNA_liftover, 
           data2$One_to_one_orth, data2$one_to_half, data2$One_to_many_orth, data2$Many_to_many_orth, data2$One_to_none_orth, 
    ...
    percentage = c(data2$lncRNA / data2$lncRNA, data2$no_lncRNA_liftover / data2$lncRNA, 
                 ...
                 data2$One_to_one_orth / data2$lncRNA_liftover, data2$one_to_half / data2$lncRNA_liftover, data2$One_to_many_orth / data2$lncRNA_liftover, 
                 data2$Many_to_many_orth / data2$lncRNA_liftover, data2$One_to_none_orth / data2$lncRNA_liftover, 
    ...
    conservation = c("conserved", "not_conserved", "conserved", "not_conserved", 
                   "conserved", "conserved", "conserved",  "conserved","not_conserved", 
    ...
    label_levels = c("lncRNA_conserved", "no_lncRNA_not_conserved", 
                 ...
                 "One_to_one_orth_conserved", "one_to_half_conserved", "One_to_many_orth_conserved",  "Many_to_many_orth_conserved","One_to_none_orth_not_conserved",
    ...
    fill_color_vector = c("lncRNA_conserved"="#156b8a", 
                      ...
                      "one_to_half_conserved"="#38A3A5",
                      "One_to_many_orth_conserved"="#57CC99",
                      "Many_to_many_orth_conserved"="#80ED99",
    ...
    alpha_vector = c("lncRNA_conserved"=1,
                 ...
                 "one_to_half_conserved"=1,
                 "One_to_many_orth_conserved"=0.8,
                 "Many_to_many_orth_conserved"=0.6,
    ...
    legend_labels = c("lncRNA_conserved"= paste0("LncRNA "),
                  ...
                  "one_to_half_conserved" = paste0("One to half"),
                  "One_to_many_orth_conserved" = paste0("One to many"),
                  "Many_to_many_orth_conserved" = paste0("Many to many"),
    ...
    #print(compare_plot)
    ggsave(paste0("./plots/Bi_Directional/", file_name, "_Bi_Directional_lncRNA_Orthologous.pdf"), plot = compare_plot, width = 8, height = 4)
}
